...
class progess extends StatefulWidget {
  const progess({super.key});

  @override
  State<progess> createState() => _progessState();
}

class _progessState extends State<progess> {
  ...
  Future<void> TaskByStatus() async {
    ...
    setState(() {});
    final reppons =
        await NetworkCaller.getRequist(Urls.ProgresslistTaskByStatus);
